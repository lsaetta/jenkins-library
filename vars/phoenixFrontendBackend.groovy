def call (String BRANCH_NAME, String CRED_ID, String PROJECT, String GIT_PROJECT_URL, String PHXVER, String RJSVER) {
				...
				parallel {
					...
					stage('build backend') {
						steps {
							...
							sh "docker rmi ${NEXUS_DOCKER_PUSH_URL}/${PROJECT}-server"
						}
					}
				}
			}
